...
namespace Carbed.ViewModels
{
    ...
    {
        private readonly SourceTextureFont data;
        ...
        // Constructor
        // -------------------------------------------------------------------
        public TextureFontViewModel(IEngineFactory factory, SourceTextureFont data)
            : base(factory, data)
        {
            this.data = data;
            ...
            this.Template = StaticResources.TextureFontTemplate;
        ...
        public Font SelectedFont
        {
            get
            {
                ...
                return this.selectableFonts.FirstOrDefault(x => x.Name == this.data.Font.Reference);
            }

            set
            {
                this.CreateUndoState();
                this.data.Font = value == null ? null : new SourceReference { Reference = value.Name, Type = SourceReferenceType.Internal };
                this.UpdatePreview();
                this.NotifyPropertyChanged();
            }
        }
        ...
        private void UpdatePreview()
        {
            ...
            if (this.data.Font == null || this.FontSize <= 0)
            {
                return;
            }
